 ...
 * 集合的嵌套遍历
 *  需求：
 *  	我们班级有学生每一个学生是不是一个对象，所以我们可以使用一个集合表示我们班级的学生。ArrayList<Studnet>
 *  	但是呢，我们旁边是不是还有一个班级，每个班级是不是也是一个ArrayList<Student>
 *  	而我们现在有多个ArrayList<Student>。也要用集合存储，怎么办呢？
